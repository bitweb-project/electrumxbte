...
import electrumxbte
from electrumxbte.server.daemon import DaemonError, Daemon
from electrumxbte.lib.hash import hash_to_hex_str, HASHX_LEN
from electrumxbte.lib.script import is_unspendable_legacy, is_unspendable_genesis
from electrumxbte.lib.util import (
    chunks, class_logger, pack_le_uint32, pack_le_uint64, unpack_le_uint64
)
from electrumxbte.lib.tx import Tx
from electrumxbte.server.db import FlushData, COMP_TXID_LEN, DB
from electrumxbte.server.history import TXNUM_LEN

if TYPE_CHECKING:
    from electrumxbte.lib.coins import Coin
    from electrumxbte.server.env import Env
    from electrumxbte.server.controller import Notifications
...
class BlockProcessor:
    ...
    async def _first_caught_up(self):
        ...
        await self.flush(True)
        if first_sync:
            self.logger.info(f'{electrumxbte.version} synced to '
    ...
    async def fetch_and_process_blocks(self, caught_up_event):
        ...
        This is mainly because if, during initial sync ElectrumXBTE is
