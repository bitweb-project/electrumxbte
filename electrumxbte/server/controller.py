...
import electrumxbte
from electrumxbte.lib.server_base import ServerBase
from electrumxbte.lib.util import version_string
from electrumxbte.server.db import DB
from electrumxbte.server.mempool import MemPool, MemPoolAPI
from electrumxbte.server.session import SessionManager
...
class Controller(ServerBase):
    ...
    async def serve(self, shutdown_event):
        ...
        self.logger.info(f'software version: {electrumxbte.version}')
