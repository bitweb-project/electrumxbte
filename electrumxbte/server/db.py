...
from electrumxbte.server.storage import db_class, Storage
from electrumxbte.server.history import History, TXNUM_LEN
    ...
    async def _open_dbs(self, for_sync: bool, compacting: bool):
        ...
        if self.utxo_db.is_new:
            ...
            with util.open_file('COIN', create=True) as f:
                f.write(f'ElectrumXBTE databases and metadata for '
