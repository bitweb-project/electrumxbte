...
from electrumxbte.lib.env_base import EnvBase
...
class Env(EnvBase):
    '''Wraps environment configuration. Optionally, accepts a Coin class
       as first argument to have ElectrumXBTE serve custom coins not part of
    ...
    def sane_max_sessions(self):
        ...
        try:
            ...
            # We give the DB 250 files; allow ElectrumXBTE 100 for itself
